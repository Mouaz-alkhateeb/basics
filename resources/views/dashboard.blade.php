        ...
        <div class="row">
            <div class="col-lg-10 col-sm-10 col-12 offset-lg-1 offset-sm-1">
                <nav class="navbar navbar-expand-lg bg-info rounded">
                    <a class="navbar-brand text-light" href="#">{{UserName()}}//{{userid()}}</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent" style="display: unset !important;">
                        <ul class="nav nav-pills mr-auto justify-content-end">
                            <li class="nav-item active">
                                <a class="nav-link text-light" href="{{url('allusers')}}">Users <span class="sr-only">(
                                        current)</span></a>
                            </li>
                            <li class="nav-item">
                                    ...
                                    <li class="head text-light bg-dark">
                                        <div class="row">
                                            <div class="col-lg-12 col-sm-12 col-12">
                                                ...
                                                <a href="{{route('notificationRead')}}" class="float-right text-light">Mark all as read</a>
                                            </div>
                                    </li>
                                    ...
                                    <li class="notification-box">
                                        <div class="row">
                                            <div class="col-lg-3 col-sm-3 col-3 text-center">
                                                <img src="images/1.png" class="w-50 rounded-circle">
                                            </div>
                                            <div class="col-lg-8 col-sm-8 col-8">
                                                <strong class="text-info">{{$notification->data['author']}}</strong>
                                                <div>
